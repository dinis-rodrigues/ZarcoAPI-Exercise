...
import com.example.ZarcoAPI.config.PropertiesConfig;
...
@Component
public class ZarcoException {

    private static PropertiesConfig propertiesConfig;

    @Autowired
    public ZarcoException(PropertiesConfig propertiesConfig) {
        ZarcoException.propertiesConfig = propertiesConfig;
    }
